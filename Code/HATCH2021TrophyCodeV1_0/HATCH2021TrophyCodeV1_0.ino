...
//////////////////////////////////////////////////////////////////////////////////////////////////
//////////  2021 Hudson Alpha Tech Challenge - TROPHY DEMO CODE - BY ANDREW DENIO 
//////////////////////////////////////////////////////////////////////////////////////////////////
...
/* 
  ...
  https://github.com/MakeItHackin/Hatch2021Trophy
 */
...
const unsigned char HudsonAlphaBitmap [] PROGMEM = {
  0x00, 0x00, 0xc0, 0xc0, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0xc0, 0x00, 0x00, 0x00, 
  ...
  , 
...
const unsigned char HATCH2020Bitmap [] PROGMEM = {
  , 
...
8 - HATCH
*/
int awardtype = 8; //CHAGE THIS VALUE TO CHANGE THE AWARD TYPE
...
void setup() {
  ...
  OzOled.drawBitmap(HATCH2020Bitmap, 0, 0, 16, 8);
...
void goToAwardMenu(){
  ...
  if (awardtype == 0){
    ...
    OzOled.printString("   HIGH SCHOOL ");  
    OzOled.setCursorXY(0,2);  
    OzOled.printString("    1st PLACE ");  
    ...
    OzOled.printString("   HIGH SCHOOL ");  
    OzOled.setCursorXY(0,2);  
    OzOled.printString("    2nd PLACE ");  
  }
  else if (awardtype == 3){
    //PROFESSIONAL FIRST PLACE
    OzOled.setCursorXY(0,0);   
    OzOled.printString("   PROFESSIONAL ");  
    OzOled.setCursorXY(0,2);  
    OzOled.printString("    1st PLACE ");  
  }
  else if (awardtype == 4){
